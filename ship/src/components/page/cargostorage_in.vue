    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item> <i class="el-icon-lx-cascades"></i> 进口货物堆存信息 </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
...
export default {
    ...
    methods: {
        selectchange() {
            ...
            Axios({
                method: 'post',
                url: this.url.url + '/post_inbei_data',
                data: param
            }).then((res) => {
                console.log(res);
        ...
        handleDelete(index, row) {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                .then(() => {
                    ...
                    Axios({
                        method: 'post',
                        url: this.url.url + '/del_inbei_data',
                        data: param
                    });
        ...
        saveInsert() {
            ...
            Axios({
                method: 'post',
                url: this.url.url + '/insert_inbei_data',
                data: param
            });
            // location.reload();
