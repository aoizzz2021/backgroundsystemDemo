    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>进口计划表</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="form-box">
                <el-form ref="form" :model="form" label-width="120px">
                    ...
                    <el-form-item label="预计工作效率及进口数量 : " label-width="200px">
                        <el-row>
                            <el-col span="8">
                                <el-input v-model="form.inp" placeholder="ERD"></el-input>
                            </el-col>
                            <el-col span="8">
                                <el-input v-model="form.incount" placeholder="进口数量"></el-input>
                            </el-col>
                        </el-row>
                    </el-form-item>
...
export default {
    ...
    methods: {
        ...
        selectchange() {
            ...
            Axios({
                method: 'post',
                url: this.url.url + '/post_insce_data',
                data: param
            }).then((res) => {
                console.log(res);
        ...
        onSubmit() {
            ...
            Axios({
                method: 'post',
                url: this.url.url + '/set_insch_data',
                data: param
            });
        ...
        handleDelete(index, row) {
            ...
            this.$confirm('确定要删除吗？', '提示', {
                ...
                .then(() => {
                    ...
                    Axios({
                        method: 'post',
                        url: this.url.url + '/del_insce_data',
                        data: param
                    });
